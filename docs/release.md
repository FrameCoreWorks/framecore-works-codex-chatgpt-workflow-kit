...
5. Verify language-first onboarding, profile approval, one-skill-at-a-time host-managed native creation, no literal `$skill-creator` command requirement, and truthful final statuses.
